...
class Program
{
    private static void Main()
    {
        ...
        Weapon sword = new Sword(requirementEnergy: 20, DamageType.PhysicalResist, damage: 46);
        ...
        switch (enemyType)
        {
            ...
            case EnemyType.Orc: npcEnemy = new Orc(weapon: nastyClub,physicalResist: 0.4f, magicResist: 0.9f, rangeResist: 0.8f, model: Model.OrcSprite, health: 250, stamina: 100); break;
